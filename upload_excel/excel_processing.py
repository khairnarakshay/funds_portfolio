...
#         equity_total = debt_total = money_market_total = others_total = cash_equivalents_total = treps_reverse_repo_total = alternative_investment_funds_units_total = net_asset_total=0
...
def SBI_Mutual_Fund(file, scheme, amc):
    ...
    try:
        ...
        others_total = others_total + money_market_total
